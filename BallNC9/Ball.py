...
class Ball:
    def __init__(self,pos,radius = 200/10,color = (255, 255, 255)):
        self.color = color
        self.radius = radius
        ...
        self.circle_shape = self.circle_body.CreateCircleFixture(radius=self.radius, density=1, friction=0.0,
                                                                 restitution=.0001)
        self.circle_body.linearVelocity = (random.uniform(0,0), random.uniform(-2,-2))
    ...
    def increase_radius(self, radius):
        ...
        self.circle_shape = self.circle_body.CreateCircleFixture(radius=self.radius, density=1, friction=0.0, restitution=0.0001)
