...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Fluid Simulation"
        # Hundreds of tiny balls behave like flowing liquid
        ...
        self.init_simulation_concept()
        
    def init_simulation_concept(self):
    ...
    def update(self):
        ...
        self.update_simulation_effects()
    ...
    def update_simulation_effects(self):
