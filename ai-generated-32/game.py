...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Tessellation Builder"
        # Balls arrange themselves into perfect geometric tessellations
        ...
        self.init_geometry_concept()
        
    def init_geometry_concept(self):
    ...
    def draw_geometry_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Tessellation Builder"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Balls arrange themselves into perfect geometric tessellation..."
