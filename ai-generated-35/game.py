...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Magnetic Field Lines"
        # Balls trace magnetic field line patterns around magnets
        ...
        self.init_electromagnetism_concept()
        
    def init_electromagnetism_concept(self):
    ...
    def update(self):
        ...
        self.update_electromagnetism_effects()
    ...
    def update_electromagnetism_effects(self):
    ...
    def draw(self):
        ...
        self.draw_electromagnetism_background()
    ...
    def draw_electromagnetism_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Magnetic Field Lines"
        font = utils.font12
