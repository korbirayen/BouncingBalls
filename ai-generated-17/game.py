...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Time Reverse Echo"
        # Ball leaves time-delayed copies that follow exact same path
        ...
        self.init_time_concept()
        
    def init_time_concept(self):
