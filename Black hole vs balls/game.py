...
class Game:
    def __init__(self):
        self.balls = [
            Ball(Vector2(utils.width / 2, utils.height / 2))
        ]
        self.blackHole = BlackHole(Vector2(utils.width/2 - 50,utils.height/2))
        # self.balls.append()
        self.particles = []
        self.boxes = []
        self.rings = [
    ...
    def draw(self):
        ...
        utils.drawText(Vector2(247,560),"BALLS: " + str(len(self.balls)),(233,233,233),utils.font16)
