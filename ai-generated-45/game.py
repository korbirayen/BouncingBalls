...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Quantum Tunneling"
        # Ball appears to tunnel through barriers quantum-style
        ...
        self.init_quantum_concept()
        
    def init_quantum_concept(self):
