...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Orbital Mechanics"
        # Balls orbit each other in perfect planetary motion
        ...
        self.init_astronomy_concept()
        
    def init_astronomy_concept(self):
    ...
    def update_astronomy_effects(self):
    ...
    def draw(self):
        ...
        self.draw_astronomy_background()
    ...
    def draw_astronomy_background(self):
        """Draw concept-specific background effects"""
