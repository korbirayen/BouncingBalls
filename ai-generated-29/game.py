...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Energy Conservation"
        # Ball height converts to speed in perfect energy demonstration
    ...
    def draw_concept_info(self):
        ...
        info_text = "Energy Conservation"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Ball height converts to speed in perfect energy demonstratio..."
