...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Wave Interference"
        # Multiple balls create ripple waves that interfere beautifully
        ...
        self.init_waves_concept()
        
    def init_waves_concept(self):
    ...
    def draw_waves_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Wave Interference"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Multiple balls create ripple waves that interfere beautifull..."
