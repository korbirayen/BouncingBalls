...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Particle Magnetism"
        # Ball attracts thousands of tiny particles into complex shapes
        ...
        self.init_emergence_concept()
        
    def init_emergence_concept(self):
    ...
    def update_emergence_effects(self):
    ...
    def draw(self):
        ...
        self.draw_emergence_background()
    ...
    def draw_emergence_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Particle Magnetism"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Ball attracts thousands of tiny particles into complex shape..."
