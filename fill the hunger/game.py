...
class Game:
    def __init__(self):
        self.balls = [
            Ball(Vector2(utils.width / 2-200, utils.height / 4))
        ]
        self.blackHole = BlackHole(Vector2(utils.width/2,utils.height/2 ))
        # self.balls.append()
        self.particles = []
        self.boxes = []
        self.rings = [
    ...
    def update(self):
        ...
        #     self.blackHole.radius = self.rings[0].radius - 80
        ...
        for ring in self.rings:
            ...
            for ball in self.balls:
                ...
                if d + ball.radius >= ring.radius:
                    ...
                    self.sounds.play()
                    if ball.canSpawnTime >= 0.5:
                        ball.canSpawnTime = -5
                        newBall = Ball(Vector2(utils.width / 2-200, utils.height / 3))
        ...
        for ball in self.balls:
            ...
            if self.check_circle_collision(self.blackHole.pos,self.blackHole.radius,ball.pos,ball.radius):
                ...
                self.blackHole.shakeTime = 0.5
                self.blackHole.radius *= 1.0009
                self.blackHole.radius -= self.blackHole.radius/100 * 0.001
    ...
    def draw(self):
        ...
        utils.drawText(Vector2(210,550),"Mushrooms: " + str(len(self.balls)),(205,0,0),utils.font16)
