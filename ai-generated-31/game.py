...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Particle Accelerator"
        # Balls spiral inward at increasing speeds like particle physics
        ...
        self.init_science_concept()
        
    def init_science_concept(self):
    ...
    def update_science_effects(self):
    ...
    def draw_science_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Particle Accelerator"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Balls spiral inward at increasing speeds like particle physi..."
