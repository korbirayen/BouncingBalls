...
CATEGORY_CAR = 0x0002
CATEGORY_BALL_BOX = 0x0003
CATEGORY_CAR_BOX = 0x0004
...
class Utils():
    ...
    def __init__(self):
        ...
        self.font8 = pygame.font.Font('assets/robot.ttf', 1)
        self.font12 = pygame.font.Font('assets/robot.ttf', 12)
        self.font16 = pygame.font.Font('assets/scoreboard.ttf', 80)
        self.font24 = pygame.font.Font('assets/robot.ttf', 50)
    ...
    def showFps(self):
        ...
        if self.fps >= 50:
            self.drawText(Vector2(0, 0), "fps: " + str(self.fps), (0, 0, 0), self.font8)
        else:
            self.drawText(Vector2(0, 0), "fps: " + str(self.fps), (0, 0, 0), self.font8)
