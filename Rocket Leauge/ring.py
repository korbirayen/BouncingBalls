...
from Box import Box
from util import utils, CATEGORY_BALL, CATEGORY_BALL_BOX
...
class Ring:
    def __init__(self, radius,dir):
        ...
        for i in range(0, 360):
            ...
            self.boxes.append(Box(Vector2(pos.x, pos.y), (255,255,255),CATEGORY_BALL_BOX, CATEGORY_BALL))
    ...
    def draw(self):
        ...
        for start_pos, end_pos in self.lines:
            pygame.draw.line(utils.screen, (233,233,23), start_pos, end_pos,3)