...
class Game:
    def __init__(self):
        # VIRAL CONCEPT: "Size Doubling Madness"
        # Ball doubles in size every 5 seconds until it fills the screen
        ...
        self.init_growth_concept()
        
    def init_growth_concept(self):
    ...
    def update_growth_effects(self):
    ...
    def draw_growth_background(self):
        """Draw concept-specific background effects"""
    ...
    def draw_concept_info(self):
        ...
        info_text = "Size Doubling Madness"
        font = utils.font12
        text_surface = font.render(info_text, True, (255, 255, 255))
        utils.screen.blit(text_surface, (10, utils.height - 30))
        
        description = "Ball doubles in size every 5 seconds until it fills the scre..."
