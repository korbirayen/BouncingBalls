...
class Game:
    def __init__(self):
        ...
        # Every collision splits ball into 2 smaller ones infinitely
        ...
        self.init_fractal_concept()
        
    def init_fractal_concept(self):
    ...
    def update_fractal_effects(self):
    ...
    def draw_fractal_background(self):
        """Draw concept-specific background effects"""
